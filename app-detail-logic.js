...
function getAppImage(app) {
  return app?.imagen || app?.icono || "logo.webp";
}
    ...
    <div class="info-grid">
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoIdioma" class="info-value">${appLanguage}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoVersion" class="info-value">${appVersion}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoTipo" class="info-value">${appType}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoSO" class="info-value">${appSystem}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoReq" class="info-value">${appRequirements}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoFechaAct" class="info-value">${appUpdate}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoEdad" class="info-value">${appAge}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoAnuncios" class="info-value">${adsLabel}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p class="info-value">${privacyHtml}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoTamañoApk" class="info-value">${appSize}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoPackageName" class="info-value">${appPackage}</p>
        </div>
      </div>
      ...
      <div class="info-box">
        ...
        <div>
          ...
          <p id="infoDescargas" class="info-value">${formatNumber(descargas)}</p>
        </div>
      </div>
    </div>
